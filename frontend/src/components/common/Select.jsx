    ...
    <div className="flex flex-col w-full">
      ...
      <div className="relative flex items-center">
        ...
        <select
          ...
          required={required}
          className={cn(
            'w-full appearance-none bg-white dark:bg-slate-800 text-sm rounded-lg border px-3.5 py-2.5 transition-all duration-150',
            'focus:outline-none focus:ring-2 focus:border-slate-800 dark:focus:border-emerald-500 focus:ring-slate-800/10 dark:focus:ring-emerald-500/10',
